...
const SimpleInterestCalculator = () => {
  ...
  const calculateSimpleInterest = () => {
    const SI = (principal * annualRate * timePeriod) / 100;
      ...
      <div className="max-w-4xl w-full bg-white bg-opacity-10 shadow-lg rounded-lg p-6 flex flex-col lg:flex-row items-center space-x-8">
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-gray-300 text-center mb-6">
            Calculate the Simple Interest and Total Amount based on your inputs.
          </p>
          ...
          {simpleInterest > 0 && (
            <div className="mt-6 bg-gray-800 bg-opacity-50 p-4 rounded-md shadow">
              ...
              <p className="text-gray-200">
                ...
                <p className="text-gray-200">
                  Simple Interest: <span className="font-bold text-white">₹{formatNumber(simpleInterest)}</span>
                </p>
                <p className="text-gray-200">
